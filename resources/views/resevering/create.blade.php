<x-base-layout>
    <div class="container mx-auto px-4 py-8">
        ...
        <form action="{{ route('resevering.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4">
                <label for="first_name" class="block text-gray-700 text-sm font-bold mb-2"></label>
                <input type="text" name="first_name" id="first_name" placeholder="Voornaam" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                {{-- <input type="hidden" name="user_id" id="user_id" value="{{ $user->id }}">  --}}

            </div>

            <div class="mb-4">
                <label for="last_name" class="block text-gray-700 text-sm font-bold mb-2"></label>
                <input type="text" name="last_name" id="last_name" placeholder="Achternaam" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>

            <div class="mb-4">
                <label for="email" class="block text-gray-700 text-sm font-bold mb-2"></label>
                <input type="email" name="email" id="email" placeholder="E-mail" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            ...
            <div class="mb-4">
                <label for="seats" class="block text-gray-700 text-sm font-bold mb-2"></label>
                <input type="number" name="seats" id="seats" placeholder="Aantal stoelen" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
